...
% Nominal values 
    ...
    VSC01_Pn = 150 * 1e6/2;                                  % Nom. VSC power [W]  
    ...
    VSC01_Un1 = 120 * 1e3;                                  % Nom. phase-to-phase VSC voltage [V]
    VSC01_Vn1 = 120 * 1e3/sqrt(3);
    VSC01_Un2 = 120 * 1e3;                                  % Nom. phase-to-phase grid voltage [V]
    VSC01_Vn2 = 120 * 1e3/sqrt(3);
    VSC01_Udc_n = 2*120 * 1e3;                                % Nom. DC voltage[V]
