...
% Nominal values  
    ...
    GRD00_Un = 400 * 1e3;                % Phase-to-Phase AC grid Voltage [V]
...
% Nominal values 
 ...
 %% Base values
    ...
    VSC01_Vb2 =     VSC01_Vn2;  % AC Voltage base value  [V]   
...
%% Transformer parameters
    ...
    % LC Filter Values in PU
    VSC01_Rf_pu = 0.005;                % Low-pass filter resistance Rf [p.u.]
    VSC01_Lf_pu = 0.15;                 % Low-pass filter inductance Lf [p.u.]
    VSC01_Cf_pu = 0.066;                % Low-pass filter capacitance Cf [p.u.]                 

    VSC01_Lf = VSC01_Lf_pu * VSC01_Lb;
    VSC01_Rf = VSC01_Rf_pu * VSC01_Zb;
    VSC01_Cf = VSC01_Cf_pu * VSC01_Cb; 
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Strategy  1
    VSC01_mp1 = 0.0043;   % Active power droop parameter 
    VSC01_wc1 = wb/10;    % The  low-pass  filter  cut-frequency 
...
% Frequency support
    ...
    VSC01_R = 4/100;   % Droop value of inertial system     
...
% Initial Active and Reactive power operating points 
 ...
 P0_VS = 0.05; % Initial Active power of Voltage Source 
...
disp('_______________Grid Forming Controllers with LCL Filter- Init. OK!_________________')